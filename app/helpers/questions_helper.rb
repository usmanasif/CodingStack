module QuestionsHelper
  ...
  def share_url(question, service)
    ...
    case service
      ...
      when :codingstack
        url = "http://codingstack.com/questions/new?question[title]="+(question.title)+"&question[tags]=#{current_group.name},share&question[body]=#{h(question.body)}%20|%20[More...](#{h(question_path(question, :only_path =>false))})"
      when :linkedin
